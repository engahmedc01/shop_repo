 ...
 * @author ahmed
 */
public class LongInputValidator extends DocumentFilter  {
    ...
    public LongInputValidator(JTextField TF, JLabel warningLabel) {
    ...
    public void insertString(DocumentFilter.FilterBypass fb, int offset, String string,
        ...
        } else if (validateLong(sb.toString())) {
    ...
    boolean validateLong(String txt) {
        try {
