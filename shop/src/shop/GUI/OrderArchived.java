 ...
 * @author Comu City
 */
public class OrderArchived extends javax.swing.JPanel {

    /**
     * Creates new form OrderArchive
     */
    
     boolean isPurchased;
    DataSourc data_source;
    Main_Frame myFrame;
    public OrderArchived(Main_Frame myFrame, DataSourc data_source) {
...
public void fillCustomersTable() {
        ...
        Vector<Object> data = data_source.getCustomers(1, 1,seasonID,myFrame.firdage_id);
    ...
    void search(String name) {
        int seasonID=data_source.getCurrentSeason();
        Vector<Object> data = data_source.getCustomerOrders(name, 1, 1,seasonID);
        if (data != null) {
