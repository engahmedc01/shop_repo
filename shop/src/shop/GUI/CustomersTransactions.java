 ...
 * @author ahmed
 */
public class CustomersTransactions extends javax.swing.JPanel {

    /**
     * Creates new form CustomersTransactions
     */
    DataSourc data_source;
    Main_Frame myFrame;
    int seasonID;
    public CustomersTransactions(Main_Frame myFrame, DataSourc data_source) {
    ...
    private void initComponents() {
        ...
        summary_table.setFont(new java.awt.Font("Arial", 0, 22)); // NOI18N
        summary_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null}
            },
            new String [] {
                "دخاخين", "العمولة", "إجمالي الموز", "الجامبو", "الدبابة"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        customerSummary_table.setFont(new java.awt.Font("Arial", 0, 22)); // NOI18N
        ...
        search_panelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, search_panelLayout.createSequentialGroup()
                .addGroup(search_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanel4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE))
                .addContainerGap())
        );
 ...
 void setDetail_table1Size() {
   ...
   String fridageName = (myFrame.firdage_id == 1) ? "ثلاجة رقم 18" : "ثلاجة رقم 21";
//        this.fridage_label1.setText(NormalizeinArabic(fridageName));
...
//        System.out.println("Number In Arabic : " + builder.toString());
  ...
  data=data_source.getPurchasedOrders(name,myFrame.firdage_id,seasonID);

  
    }else{
       data=data_source.getCustomerOrders(name,myFrame.firdage_id,seasonID);}
     ...
     dtm=(DefaultTableModel)customerSummary_table.getModel();
        double tips=data_source.getSumTips(name,seasonID);
        double commssion=data_source.getSumCommision(name,seasonID);
        double netPrice=data_source.getSumTotalOrders(name,seasonID);

        int vechil1Count=data_source.getVechile1Count(name,seasonID);
        int vechil2Count=data_source.getVechile2Count(name,seasonID);
        
        Vector<Object>row=new Vector<Object>(Arrays.asList(tips,commssion,netPrice,vechil2Count,vechil1Count));
...
//detail_table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void Ocustomers_RBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ocustomers_RBActionPerformed
        ...
        Vector<Object>data=data_source.getAllOCustomersNames(myFrame.firdage_id,seasonID);
...
//        int firdage_id=fridage_CB.getSelectedIndex()+1;
        ...
        double tips=data_source.getCustomersTipsAmount(seasonID);
        double commssion=data_source.getCustomersOrdersCommssionAmount(seasonID);
        double netamount=data_source.getCustomersOrdersNetAmount(seasonID);
        int vechil1Count=data_source.getCustomerVechile1Count(seasonID);
        int vechil2Count=data_source.getCustomerVechile2Count(seasonID);
        Vector<Object>row=new Vector<Object>(Arrays.asList(tips,commssion,netamount,vechil2Count,vechil1Count));
        dtm.setDataVector(new Vector<Object>(Arrays.asList(row)), customerSummary_columnTitles);
    ...
    private void PCustomers_RBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PCustomers_RBActionPerformed
        ...
        DefaultTableModel dtm=(DefaultTableModel)customers_table.getModel();
        Vector<Object>data=data_source.getAllPurchaseCustomers(myFrame.firdage_id,seasonID);
        dtm.setDataVector(data, customerTable_ColumnTitle);
        customers_table.setModel(dtm);
        
//        int firdage_id=fridage_CB.getSelectedIndex()+1;
        dtm=(DefaultTableModel)summary_table.getModel();
        double tips=data_source.getPurchasedTipsAmount(seasonID);
        double commssion=data_source.getPurchasesOrdersCommssionAmount(seasonID);
        double ordernetPrice=data_source.getPurchasesOrdersNetAmount(seasonID);
        int vechil1Count=data_source.getPurchasedVechile1Count(seasonID);
        int vechil2Count=data_source.getPurchasedVechile2Count(seasonID);
        Vector<Object>row=new Vector<Object>(Arrays.asList(tips,commssion,ordernetPrice,vechil2Count,vechil1Count));
        dtm.setDataVector(new Vector<Object>(Arrays.asList(row)), customerSummary_columnTitles);
        summary_table.setModel(dtm);
    ...
    private void KCustomers_RBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KCustomers_RBActionPerformed
        ...
        DefaultTableModel dtm=(DefaultTableModel)customers_table.getModel();
        Vector<Object>data=data_source.getAllKareemNames(myFrame.firdage_id,seasonID);
        dtm.setDataVector(data, customerTable_ColumnTitle);
        customers_table.setModel(dtm);
        
//        int firdage_id=fridage_CB.getSelectedIndex()+1;
        dtm=(DefaultTableModel)summary_table.getModel();
        double tips=data_source.getKareemTipsAmount(seasonID);
        double commssion=data_source.getKareemOrdersCommssionAmount(seasonID);
        double totalOrders=data_source.getKareemTotalOrdersAmount(seasonID);
        
        int vechil1Count=data_source.getkareemVechile1Count(seasonID);
        int vechil2Count=data_source.getkareemVechile2Count(seasonID);
        Vector<Object>row=new Vector<Object>(Arrays.asList(tips,commssion,totalOrders,vechil2Count,vechil1Count));
        dtm.setDataVector(new Vector<Object>(Arrays.asList(row)), customerSummary_columnTitles);
        summary_table.setModel(dtm);
...
Vector<String>customerSummary_columnTitles=new Vector<>(Arrays.asList(              "دخاخين", "العمولة", "إجمالي الموز", "الجامبو", "الدبابة"
