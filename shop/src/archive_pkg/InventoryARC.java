 ...
 * @author Ahmed
 */
public class InventoryARC extends javax.swing.JPanel {

    /**
     * Creates new form InventoryARC
     */
    boolean fillMode;
    ...
    public InventoryARC(JFrame myFrame, DataSourc data_source, int seasonID) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 204), 1, true));
...
public void refrishPage(int seasonID) {
      this.seasonID=seasonID;         
